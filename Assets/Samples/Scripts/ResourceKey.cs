namespace Demo.Scripts
{
    public static class ResourceKey
    {
        ...
        private const string GreenScreenPrefabName = "screen_green";
        private const string RedScreenPrefabName = "screen_red";
        ...
        public static string GreenScreenPrefab()
        {
            return string.Format(PrefabFormat, GreenScreenPrefabName);
        }
        
        public static string RedScreenPrefab()
        {
            return string.Format(PrefabFormat, RedScreenPrefabName);
        }
